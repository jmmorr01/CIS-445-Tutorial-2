...
BAD CLAGE DELINQ G_JOB NINQ YOJ );
run;
*------------------------------------------------------------* ;
...
train tech=NONE;
code file="J:\JMMORR01\CIS 445\Tutorial 2\My Project\Workspaces\EMWS1\Neural2\SCORECODE.sas"
group=Neural2
;
;
code file="J:\JMMORR01\CIS 445\Tutorial 2\My Project\Workspaces\EMWS1\Neural2\RESIDUALSCORECODE.sas"
group=Neural2
residual
;
;
